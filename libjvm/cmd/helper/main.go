...
import (
	...
	provider "github.com/pivotal-david-osullivan/jvm-multi-provider/libjvm"
	"github.com/pivotal-david-osullivan/jvm-multi-provider/libjvm/helper"
	"os"
)
...
func main() {
	sherpa.Execute(func() error {
		var (
			...
			cl = provider.NewCertificateLoader()
